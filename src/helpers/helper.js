...
const filterProducts = (products, category) =>{
    ...
    const filterdProducts = products.filter(p => p.category.toLowerCase().includes(category));
...
export {shortenText, searchProducts, filterProducts, createQueryObject, getInitialQuery, sumPrducts, productQuantity}